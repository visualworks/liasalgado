<?php get_header(); ?>
    ...
    <div class="grid_8 posts-wrap">
        <h1 class="resultado-busca" style="padding-top:18px">Resultado da busca por <span class="termo-busca"><?php the_search_query(); ?></span>:</h1>
        <?php if (have_posts()): ?>
        ...
        <?php endwhile; else : ?>
        <div class="post">
            <h1 class="resultado-busca">Desculpe. Nada encontrado.</h1>
